...
fn main() {
    ...
    cxx_build::bridge("src/lib.rs")
        .file("src/shim.cc")
        .file("vendor/geographiclib/src/DST.cpp")
        .file("vendor/geographiclib/src/EllipticFunction.cpp")
        .file("vendor/geographiclib/src/Geodesic.cpp")
        .file("vendor/geographiclib/src/GeodesicExact.cpp")
        .file("vendor/geographiclib/src/Math.cpp")
        .std("c++14")
