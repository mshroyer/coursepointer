...
/// Compute point of interception along a geodesic
///
/// Given a segment of a geodesic and another point, returns the point along the
/// geodesic segment with the minimum geodesic distance from the given point.
